...
* **Cutting-edge library developers:** Some developers use dask within their own libraries. Current projects include _`xray`:_`http://xray.readthedocs.org/en/stable/dask.html (climate science), _`scikit-image`:http://scikit-image.org/docs/stable/ and _`scikit-allel`:https://scikits.appspot.com/scikit-allel (genomics). The developers of these libraries use dask to accelerate interactive analysis of large datasets in their domains.
