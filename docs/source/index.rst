...
* **Big pandas seekers:** Dask.dataframe is useful to process data files that are larger than can fit in available memory, providing some limited pandas-like ability. It covers part, but not all, of the `pandas`_ API.
