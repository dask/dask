...
Dask is an open source project that welcomes contributions from a diverse community of developers. 
We encourage the use of automations and AI tools to assist in code development, documentation, and testing.
However, we ask that contributors use these tools responsibly and avoid antisocial behaviour. 

When using automated tools, please ensure that you:

- Do not use tools to speak for you in discussions, code reviews, or any other interactions within the Dask 
community except for simple proof reading and translation.
- Review output generated by tools before asking someone else to review it. 
...
- Disclose your use of automated tools and AI, either in the pull request description or the commit. 
Even better share your prompts and plans to help other learn.
- Be prepared to respond to review feedback and iterate on your contributions. 
Do not blindly copy and paste feedback to the LLM and ask it to generate a new PR.
- Follow the project's coding standards and guidelines. 
AI agents often do not fill in issue or PR templates, write these yourself.
- Do not use AI to solve `good first issues`. These are intended for humans to learn and grow within the project.
