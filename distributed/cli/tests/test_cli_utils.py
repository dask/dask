...
def test_uri_from_host_port():
    ...
    assert f('zmq://192.168.1.2:456', None, None) == 'zmq://192.168.1.2:456'
    assert f('zmq://192.168.1.2:456', 0, 0) == 'zmq://192.168.1.2:456'
    assert f('zmq://192.168.1.2:456', 0, 123) == 'zmq://192.168.1.2:456'
    assert f('zmq://192.168.1.2:456', 456, 123) == 'zmq://192.168.1.2:456'
