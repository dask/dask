...
def apply_concat_apply(
    ...
    **kwargs,
    ...
    if shuffle:
        ...
        if split_out == 1:
            raise ValueError  # Need to discourage this somehow...
        ...
        shuffled = chunked.shuffle(
            chunked.index,
            ignore_index=False,
            npartitions=split_out,
            **shuffle_kwarg,
        )
        return shuffled.map_partitions(combine, **combine_kwargs).map_partitions(
