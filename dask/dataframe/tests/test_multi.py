...
def test_merge(how, shuffle):
    ...
    assert_eq(result, pd.merge(A, B, on="y", how=how))
    ...
    assert_eq(dd.merge(a, b, how=how, shuffle=shuffle), pd.merge(A, B, how=how))
    assert_eq(dd.merge(a, B, how=how, shuffle=shuffle), pd.merge(A, B, how=how))
    assert_eq(dd.merge(A, b, how=how, shuffle=shuffle), pd.merge(A, B, how=how))
    assert_eq(dd.merge(A, B, how=how, shuffle=shuffle), pd.merge(A, B, how=how))
    ...
    # assert_eq(dd.merge(a, B, left_index=True, right_on='y'),
