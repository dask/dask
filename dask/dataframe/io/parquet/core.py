...
def to_parquet(
    ...
    **kwargs,
    ...
    compression : string or dict, optional, default 'default'
    ...
    write_index : boolean, optional, default True
    ...
    ignore_divisions : bool, optional, default False
        If False (default) raises error when previous divisions overlap with
        the new appended divisions. Ignored if append=False.
    partition_on : list, optional, default None
        Construct directory-based partitioning by splitting on these fields'
        values. Each dask partition will result in one or more datafiles,
        there will be no global groupby.
    storage_options : dict, optional, default None
        Key/value pairs to be passed on to the file-system backend, if any.
    custom_metadata : dict, optional, default None
    ...
    write_metadata_file : bool, optional, default True
        Whether to write the special "_metadata" file.
    compute : bool, optional
        If True (default) then the result is computed immediately. If False
        then a ``dask.delayed`` object is returned for future computation.
    compute_kwargs : dict, optional, default True
        Options to be passed in to the compute method
    schema : Schema object, dict, or {"infer", None}, optional, default None
