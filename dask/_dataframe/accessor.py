...
from dask._dataframe._compat import check_to_pydatetime_deprecation
...
class Accessor:
    ...
    def __init__(self, series):
        from dask._dataframe.core import Series
...
class StringAccessor(Accessor):
    ...
    def cat(self, others=None, sep=None, na_rep=None):
        from dask._dataframe.core import Index, Series
