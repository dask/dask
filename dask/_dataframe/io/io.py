...
from dask._dataframe.dispatch import meta_lib_from_array
...
def from_pandas(
    ...
    a dask._dataframe from those parts on which Dask.dataframe can operate in
...
def from_delayed(
    ...
    if divisions == "sorted":
        from dask._dataframe.shuffle import compute_and_set_divisions
