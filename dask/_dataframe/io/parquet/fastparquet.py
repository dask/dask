...
from dask._dataframe._compat import PANDAS_GE_201
...
from dask._dataframe.io.utils import _is_local_fs, _meta_from_dtypes, _open_input_files
from dask._dataframe.utils import UNKNOWN_CATEGORIES
        ...
        **kwargs,
        ...
        if append:
            try:
                ...
                append = False
        if append:
            from dask._dataframe._pyarrow import to_object_string
