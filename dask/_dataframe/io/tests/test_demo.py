...
from dask._dataframe._compat import PANDAS_GE_200, PANDAS_GE_220, tm
from dask._dataframe.optimize import optimize_dataframe_getitem
from dask._dataframe.utils import assert_eq, get_string_dtype
...
def test_with_spec(seed):
    ...
    from dask._dataframe.io.demo import DatasetSpec, with_spec
...
def test_with_spec_non_default(seed):
    from dask._dataframe.io.demo import (
        ColumnSpec,
        DatasetSpec,
        RangeIndexSpec,
        with_spec,
