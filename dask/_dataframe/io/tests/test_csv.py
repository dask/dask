...
import dask
from dask._dataframe._compat import PANDAS_GE_140, PANDAS_GE_200, PANDAS_GE_220, tm
from dask._dataframe.io.csv import (
    _infer_block_size,
    auto_blocksize,
    block_mask,
    pandas_read_text,
...
def test_auto_blocksize_csv(monkeypatch):
    ...
    monkeypatch.setattr(dask._dataframe.io.csv, "read_bytes", mock_read_bytes)
