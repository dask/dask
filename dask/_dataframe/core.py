...
from dask._dataframe import methods
...
from dask._dataframe.accessor import CachedAccessor, DatetimeAccessor, StringAccessor
from dask._dataframe.categorical import CategoricalAccessor, categorize
from dask._dataframe.dispatch import (
    get_parallel_type,
...
from dask._dataframe.utils import (
...
def _dummy_numpy_dispatcher(
    *arg_names: Literal["dtype", "out"], deprecated: bool = False
    ...
    These parameters are deprecated in all dask._dataframe reduction methods
...
class _Frame(DaskMethodsMixin, OperatorMethodMixin):
    ...
    def __init__(self, dsk, name, meta, divisions):
        ...
        if pyarrow_strings_enabled() and "read-parquet" not in name:
            from dask._dataframe._pyarrow import check_pyarrow_string_supported

            check_pyarrow_string_supported()

            from dask._dataframe._pyarrow import (
...
Dask Name: {name}, {layers}"""
    ...
    def reset_index(self, drop=False):
        ...
        Note that unlike in ``pandas``, the reset ``dask._dataframe`` index will
    ...
    def compute_current_divisions(self, col=None):
        ...
        from dask._dataframe.shuffle import compute_divisions
    ...
    def loc(self):
        ...
        """
        from dask._dataframe.indexing import _LocIndexer
    ...
    def shuffle(
        ...
        """
        from dask._dataframe.shuffle import shuffle as dd_shuffle
    ...
    def to_sql(
        ...
        from dask._dataframe.io.sql import to_sql
    ...
    def to_backend(self, backend: str | None = None, **kwargs):
        ...
        """
        from dask._dataframe.io.io import to_backend
    ...
    def rolling(
        ...
        """
        from dask._dataframe.rolling import Rolling
        ...
        def append(self, other, interleave_partitions=False):
            if PANDAS_GE_140:
                warnings.warn(
                    ...
                    "dask in a future version. Use dask._dataframe.concat instead.",
                    FutureWarning,
                )
            # because DataFrame.append will override the method,
            # wrap by pd.Series.append docstring
            from dask._dataframe.multi import concat
    ...
    def resample(self, rule, closed=None, label=None):
        from dask._dataframe.tseries.resample import Resampler
    ...
    def nunique_approx(self, split_every=None):
        ...
        """
        from dask._dataframe import hyperloglog  # here to avoid circular import issues
...
class Series(_Frame):
    ...
    def __array_wrap__(self, array, context=None):
        if isinstance(context, tuple) and len(context) > 0:
            ...
            raise NotImplementedError(
                f"{method_name} is not implemented for `dask._dataframe.Series`."
            )
...
Dask Name: {name}, {layers}""".format(
    ...
    def _repartition_quantiles(self, npartitions, upsample=1.0):
        ...
        from dask._dataframe.partitionquantiles import partition_quantiles
    ...
    def groupby(
        ...
        **kwargs,
        ...
        from dask._dataframe.groupby import SeriesGroupBy
    ...
    def cov(self, other, min_periods=None, split_every=False):
        ...
        if not isinstance(other, Series):
            raise TypeError("other must be a dask._dataframe.Series")
...
class DataFrame(_Frame):
    ...
    def iloc(self):
        ...
        """
        from dask._dataframe.indexing import _iLocIndexer
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, Series):
            ...
            if self.divisions != key.divisions:
                from dask._dataframe.multi import _maybe_align_partitions
    ...
    def sort_values(
        ...
        **kwargs,
        ...
        """
        from dask._dataframe.shuffle import sort_values
    ...
    def set_index(
        ...
        **kwargs,
        ...
        if pre_sorted:
            from dask._dataframe.shuffle import set_sorted_index

            return set_sorted_index(
                self, other, drop=drop, divisions=divisions, **kwargs
            )
        else:
            from dask._dataframe.shuffle import set_index
    ...
    def groupby(
        ...
        **kwargs,
        ...
        from dask._dataframe.groupby import DataFrameGroupBy
    ...
    def merge(
        ...
        from dask._dataframe.multi import merge
    ...
    def join(
        ...
        if not is_dataframe_like(other):
            ...
            from dask._dataframe.multi import _recursive_pairwise_outer_join
    ...
    def pivot_table(self, index=None, columns=None, values=None, aggfunc="mean"):
        ...
        table : DataFrame
        """
        from dask._dataframe.reshape import pivot_table
    ...
    def melt(
        ...
        """
        from dask._dataframe.reshape import melt
...
def repartition(df, divisions=None, force=False):
    ...
    if isinstance(df, _Frame):
        ...
        from dask._dataframe.utils import shard_df_on_index
