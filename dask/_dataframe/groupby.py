...
from dask._dataframe.dispatch import grouper_dispatch
from dask._dataframe.methods import concat, drop_columns
...
class _GroupBy:
    ...
    def rolling(self, window, min_periods=None, center=False, win_type=None, axis=0):
        ...
        """
        from dask._dataframe.rolling import RollingGroupby
