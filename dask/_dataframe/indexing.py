...
from dask._dataframe._compat import IndexingError
from dask._dataframe.core import Series, new_dd_object
from dask._dataframe.utils import is_index_like, is_series_like, meta_nonempty
...
class _iLocIndexer(_IndexerBase):
    ...
    def __getitem__(self, key):
        ...
        if not self.obj.columns.is_unique:
            ...
            # otherwise dispatch to dask._dataframe.core.DataFrame.__getitem__
