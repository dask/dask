...
from dask._dataframe import extensions

pd = pytest.importorskip("pandas")
import dask.dataframe as dd
from dask._dataframe._compat import PANDAS_GE_140, PANDAS_GE_210
from dask._dataframe._pyarrow import to_pyarrow_string
...
@pytest.mark.parametrize(
    "obj, registrar",
    [
        (dd.Series, extensions.register_series_accessor),
        (dd.DataFrame, extensions.register_dataframe_accessor),
        (dd.Index, extensions.register_index_accessor),
    ],
)
...
def test_accessor_works():
    with ensure_removed(dd.Series, "mine"):
        extensions.register_series_accessor("mine")(MyAccessor)
