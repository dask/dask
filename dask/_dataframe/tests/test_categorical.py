...
from dask._dataframe import _compat
from dask._dataframe._compat import PANDAS_GE_150, PANDAS_GE_200, PANDAS_GE_210, tm
from dask._dataframe._pyarrow import to_pyarrow_string
from dask._dataframe.core import _concat
...
def test_categorical_dtype():
    cat_dtype = dask._dataframe.categorical.categorical_dtype(
