...
from dask._dataframe.dispatch import group_split_dispatch, hash_object_dispatch
from dask._dataframe.io.io import from_pandas
from dask._dataframe.shuffle import (
    partitioning_index,
...
def merge(
    ...
    # Transform pandas objects into dask._dataframe objects
